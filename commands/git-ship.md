...
You are a git management expert. Execute the full git workflow on the **current branch**. Follow the git reference skill at `~/.claude/skills/git/SKILL.md` for commit message standards, PR templates, and quality rules.
