...
argument-hint: "[empty | failed | next | focus | changed | parallel | coverage | feature | seed:NNNN | path | --flag]"
---
...
Use the `rails-test` skill. Pick the rspec invocation per `references/run-selection.md`.
